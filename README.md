...
A token is basically an access pass that is granted by the server after the user is authenticated.

2. What steps can you take in your web apps to keep your data secure?
   Build private routes, impliment roles(authorization) and access (authentication)

. Describe how web servers work.
Web servers serve and store data that we can use via an API to interact with.
